...
Insertion:
    ...
    Average Case: O(1) - Assuming the hash functions and probing sequence yield a good distribution.
    Worst Case: O(n) - In case of many collisions and full table, all slots might be probed.
